...
export CFLAGS="-fexceptions -sFORCE_FILESYSTEM -sSUPPORT_LONGJMP=emscripten"
export LDFLAGS="-flto -sASYNCIFY -sEXPORTED_FUNCTIONS=_main -sENVIRONMENT=web -lidbfs.js -Wl,-u,ntohs $CFLAGS"
